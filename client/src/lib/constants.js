export const initialClientesData = [
  {
    ...
    ultimaRX: {
      ...
      os: { sph: -3.0, cyl: -0.5, axis: 175, dp: 32.0 },
      add: "+1.75",
  ...
  },
  {
    ...
    ultimaCompra: {
      item: "Lentes de Contacto Acuvue",
      precio: 60.0,
      fecha: "2024-05-01",
    },
    ultimaRX: {
    ...
    historialCitas: [
      {
        ...
        fecha: "2024-04-10",
        hora: "14:00",
        motivo: "Adaptación Lentes de Contacto",
        estado: "Completada",
      },
    ],
    notasCount: 0,
  ...
  },
  {
    ...
    ultimaCompra: {
      item: "Gafas de Sol Ray-Ban Graduadas",
      precio: 220.75,
      fecha: "2024-03-15",
    },
    ultimaRX: {
      id: "rx1_laura",
      fecha: "2024-02-28",
      od: { sph: 0.0, cyl: -1.0, axis: 90, dp: 30.5 },
      os: { sph: 0.0, cyl: -1.25, axis: 85, dp: 31.0 },
    ...
    notasCount: 1,
    avatarUrl:
      "https://avatar.vercel.sh/laura.martinez@example.com.png?size=60",
  },
  {
    id: 4,
    nombre: "Pedro",
    ...
    ultimaCompra: {
      item: "Armazón + Lentes Blue Protect",
      precio: 180.5,
      fecha: "2024-01-20",
    },
    ultimaRX: {
...
export const initialFormulasData = initialClientesData.reduce(
  (acc, cliente) => {
    if (cliente.historialRX) {
      cliente.historialRX.forEach((rx) => {
        const fullRxDetails =
          cliente.ultimaRX?.id === rx.id ? cliente.ultimaRX : rx;
        acc.push({
  ...
  if (cliente.historialCitas) {
    cliente.historialCitas.forEach((cita) => {
      acc.push({
        ...
        title: `${cita.motivo || "Cita"} - ${cliente.nombre} ${
          cliente.apellido
        }`, // for calendar view
        start: `${cita.fecha}T${cita.hora || "09:00"}:00`,
        end: `${cita.fecha}T${
          cita.hora
            ? (parseInt(cita.hora.split(":")[0]) + 1)
                .toString()
                .padStart(2, "0")
            : "10"
        }:${cita.hora ? cita.hora.split(":")[1] : "00"}:00`,
        clienteId: cliente.id,
        clienteNombre: `${cliente.nombre} ${cliente.apellido}`,
...
export const initialInventarioData = [
  ...
  {
    id: "LEN001",
    tipo: "Lente Oftálmico",
    nombre: "Zeiss Progresivo Individual 2",
    marca: "Zeiss",
    material: "CR-39",
    indice: "1.50",
    stock: 50,
  ...
  },
  {
    id: "LEN002",
    tipo: "Lente Oftálmico",
    nombre: "Essilor Varilux Comfort",
    marca: "Essilor",
    material: "Policarbonato",
    indice: "1.59",
    stock: 40,
  ...
  {
    id: "CON001",
    tipo: "Lente de Contacto",
    nombre: "Acuvue Oasys 1-Day",
...
export const initialPedidosData = [
  {
    ...
    fechaPedido: "2024-05-01",
    fechaEstimadaEntrega: "2024-05-10",
    estado: "En Laboratorio",
    laboratorio: "LAB001",
    total: 270.0,
    items: [
      { itemId: "ARM001", cantidad: 1, precio: 150.0 },
      { itemId: "LEN001", cantidad: 1, precio: 120.0 },
    ],
  },
  {
    id: "PED002",
    ...
    fechaEstimadaEntrega: "2024-05-08",
    estado: "Enviado",
    laboratorio: "LAB003",
    total: 45.0,
    items: [{ itemId: "CON001", cantidad: 1, precio: 45.0 }],
  },
  {
    id: "PED003",
    clienteId: 3,
    ...
    fechaEstimadaEntrega: "2024-05-05",
    estado: "Recibido en Óptica",
    laboratorio: "LAB002",
    total: 340.0,
    items: [
      { itemId: "ARM003", cantidad: 1, precio: 200.0 },
      { itemId: "LEN002", cantidad: 1, precio: 140.0 },
    ],
  },
];
...
export const initialEntregasData = [
  {
    ...
    notas: "Cliente satisfecho con los progresivos.",
    entregadoPor: "Admin",
  },
  {
    id: "ENT002",
    ...
    notas: "Instrucciones de cuidado de lentes de contacto dadas.",
    entregadoPor: "Admin",
  },
];
...
export const initialProveedoresData = [
  {
    ...
    contacto: "Juan Pérez",
    email: "ventas@luxottica.es",
    telefono: "555-0011",
    direccion: "Milán, Italia",
    tipo: "Armazones",
    notas: "Principal proveedor de marcas de lujo.",
  },
  {
    id: "PROV002",
    nombre: "Kering Eyewear",
    contacto: "Maria Lopez",
    email: "contacto@keringeyewear.com",
    telefono: "555-0022",
    direccion: "Padua, Italia",
    tipo: "Armazones, Gafas de Sol",
    notas: "Marcas como Gucci, Saint Laurent.",
  },
  {
    id: "LAB001",
    nombre: "Zeiss Vision Care",
    contacto: "Carlos Sanchez",
    email: "laboratorio@zeiss.es",
    telefono: "555-0033",
    direccion: "Aalen, Alemania",
    tipo: "Lentes Oftálmicos",
    notas: "Lentes de alta precisión.",
  },
  {
    id: "LAB002",
    nombre: "EssilorLuxottica Lab",
    contacto: "Laura Garcia",
    email: "lab.es@essilor.com",
    telefono: "555-0044",
    direccion: "Charenton-le-Pont, Francia",
    tipo: "Lentes Oftálmicos",
    notas: "Amplia gama de lentes Varilux.",
  },
  {
    id: "LAB003",
    nombre: "CooperVision Iberia",
    contacto: "Pedro Martin",
    email: "pedidos@coopervision.es",
    telefono: "555-0055",
    direccion: "Madrid, España",
    tipo: "Lentes de Contacto",
    notas: "Especialistas en lentes de contacto.",
  },
];
...
export const tiposProductoInventario = [
  "Armazón",
  "Lente Oftálmico",
  "Gafa de Sol",
  "Lente de Contacto",
...
export const opcionesCondiciones = [
  "Miopía",
  "Hipermetropía",
  "Astigmatismo",
  "Presbicia",
